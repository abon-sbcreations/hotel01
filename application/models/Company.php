...
class Company extends CI_Model {
    ...
    public function getCompany($params) {
        $this->db->select("comp_id,comp_name,comp_reg_no,comp_address");
    ...
    public function postCompany($company) {
        $this->db->insert($this->_company_master, ['comp_name' => $company['comp_name'],
            'comp_reg_no' => $company['comp_reg_no'],
            'comp_address' => $company['comp_address']
                ]);
    }
    public function putCompany($company) {
        $this->db->update($this->_company_master, ['comp_name' => $company['comp_name'],
            'comp_reg_no' => $company['comp_reg_no'],
            'comp_address' => $company['comp_address']
