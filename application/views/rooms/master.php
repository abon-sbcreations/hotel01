        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10 col-lg-offset-2">
                    <div class="h2"><span>Room Management</span><span class="addbttn"><button onclick="addRoomType()" class="btn btn-info">Add Room Type</button></span></div>
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        <form method="post" name="roomDetailEdit" id="roomDetailEdit" >
                            ...
                            <div class="row">
                                <div class="form-group col-md-10">
                                    <label for="room_type_Desc">Room Description</label>
