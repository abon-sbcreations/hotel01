CREATE TABLE IF NOT EXISTS tbl_hotel_master (
    hotel_id INT(4) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS room_item_master (
    room_item_id int(4) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS hotel_room_item (
    hotel_room_item_id int(4) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS website_operator (
    operator_id int(4) AUTO_INCREMENT PRIMARY KEY,
